...
class Swift_Mime_SimpleMessageTest extends Swift_Mime_MimePartTest
{
    ...
    public function testDateIsReturnedFromHeader()
    {
        ...
        $message = $this->createMessage($this->createHeaderSet(array(
            'Date' => $date
    ...
    public function testSenderIsReturnedFromHeader()
    {
         ...
         * -- RFC 2822, 3.6.2.
         */
        $sender = $this->createHeader('Sender', array(
            'sender@domain' => 'Name'
        ));
        $message = $this->createMessage($this->createHeaderSet(array(
            'Sender' => $sender
    ...
    public function testFromIsReturnedFromHeader()
    {
         ...
         * -- RFC 2822, 3.6.2.
         */
        $from = $this->createHeader('From', array(
            'from@domain' => 'Name'
        ));
        $message = $this->createMessage($this->createHeaderSet(array(
            'From' => $from
    ...
    public function testReplyToIsReturnedFromHeader()
    {
         ...
         * -- RFC 2822, 3.6.2.
         */
        $reply = $this->createHeader('Reply-To', array(
            'reply@domain' => 'Name'
        ));
        $message = $this->createMessage($this->createHeaderSet(array(
            'Reply-To' => $reply
    ...
    {
        $replyTo = $this->createHeader('Reply-To', array(
            'from@domain' => 'Name'
        ), array(), false);
    ...
    public function testBccIsReturnedFromHeader()
    {
         ...
         * -- RFC 2822, 3.6.3.
         */
        $bcc = $this->createHeader('Bcc', array(
            'bcc@domain' => 'Name'
        ));
        $message = $this->createMessage($this->createHeaderSet(array(
            'Bcc' => $bcc
    ...
    {
        $rcpt = $this->createHeader('Disposition-Notification-To', array(
