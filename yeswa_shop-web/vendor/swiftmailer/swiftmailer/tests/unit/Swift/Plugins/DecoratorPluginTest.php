...
class Swift_Plugins_DecoratorPluginTest extends \SwiftMailerTestCase
{
    ...
    {
        $message = $this->createMessage($this->createHeaders(), array(
        ...
        $plugin = $this->createPlugin(array(
    ...
    public function testReplacementsCanBeMadeInHeaders()
    {
        ...
        $message = $this->createMessage($headers, array(
            'zip@button.tld' => 'Zipathon'
        ), array(
            'chris.corbyn@swiftmailer.org' => 'Chris'
    ...
    private function createMessage($headers, $to = array(), $from = null, $subject = null, $body = null)
    {
