...
class Swift_Transport_Esmtp_Auth_NTLMAuthenticatorTest extends \SwiftMailerTestCase
{
    ...
    public function testLMv1Generator()
    {
        ...
        $login = $this->getAuthenticator();
        $lmv1Result = $this->invokePrivateMethod('createLMPassword', $login, array(
            $password,
            hex2bin($challenge)
        ));
    ...
    public function testLMv2Generator()
    {
        ...
        $login = $this->getAuthenticator();
        $lmv2Result = $this->invokePrivateMethod('createLMv2Password', $login, array(
            $password,
            $username,
            $domain,
            hex2bin($challenge),
    ...
    public function testMessage3v1Generator()
    {
        ...
        $login = $this->getAuthenticator();
        $message3 = $this->invokePrivateMethod('createMessage3', $login, array(
            $domain,
            $username,
            $workstation,
            hex2bin($lmResponse),
    ...
    public function testGetDomainAndUsername()
    {
        ...
        $login = $this->getAuthenticator();
        list ($domain, $user) = $this->invokePrivateMethod('getDomainAndUsername', $login, array(
            $username
        ));
    ...
    public function testSuccessfulAuthentication()
    {
        ...
        $agent->shouldReceive('executeCommand')
            ->once()
            ->with(base64_encode($this->invokePrivateMethod('createMessage3', $ntlm, array(
            $domain,
            $username,
