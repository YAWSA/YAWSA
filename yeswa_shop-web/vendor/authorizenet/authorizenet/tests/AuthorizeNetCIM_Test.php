...
class AuthorizeNetCIM_Test extends PHPUnit_Framework_TestCase
{
    ...
    public function testCreateCustomerProfile()
    {
        ...
        $testPayment = ($response->xml->profile->paymentProfiles[0]->payment->creditCard) ? ($response->xml->profile->paymentProfiles[0]->payment) : ($response->xml->profile->paymentProfiles[1]->payment);
