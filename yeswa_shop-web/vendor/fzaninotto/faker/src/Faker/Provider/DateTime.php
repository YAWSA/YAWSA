...
class DateTime extends Base
{
     ...
     *            time zone in which the date time should be set, default to result of `date_default_timezone_get`
    ...
    {
        return static::setTimezone(new \DateTime('@' . static::unixTime($max)), (null === $timezone ? date_default_timezone_get() : $timezone));
    }
    ...
    public static function dateTimeAD($max = 'now', $timezone = null)
    {
        ...
        return static::setTimezone(new \DateTime('@' . mt_rand($min, static::getMaxTimestamp($max))), (null === $timezone ? date_default_timezone_get() : $timezone));
    }
    ...
    public static function dateTimeBetween($startDate = '-30 years', $endDate = 'now', $timezone = null)
    {
        ...
        return static::setTimezone(new \DateTime('@' . $timestamp), (null === $timezone ? date_default_timezone_get() : $timezone));
    }
    ...
    public static function dateTimeInInterval($date = '-30 years', $interval = '+5 days', $timezone = null)
    {
        ...
        return static::dateTimeBetween($begin, $end, (null === $timezone ? date_default_timezone_get() : $timezone));
    }
