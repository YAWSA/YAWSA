...
class Infinite_Scroll_Options
{
    ...
    function __construct(&$parent)
    {
        ...
        add_filter($this->parent->prefix . 'js_options', array(
            &$this,
            'db_version_filter'
        ));
    }
    ...
    {
        register_setting($this->parent->slug_, $this->parent->slug_, array(
            &$this,
            'validate'
        ));
    }
     ...
     *            the options array
     * @param bool $merge
     *            (optional) whether or not to merge options arrays or overwrite
     * @return bool success/fail
     */
