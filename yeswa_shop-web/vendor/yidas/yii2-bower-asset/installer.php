...
class Installer
{
     ...
     */
    private static $sourceBower = 'yidas' . DIRECTORY_SEPARATOR . 'yii2-bower-asset' . DIRECTORY_SEPARATOR . 'bower';
     ...
     */
    private static $aliasFilePath = 'vendor' . DIRECTORY_SEPARATOR . 'yiisoft' . DIRECTORY_SEPARATOR . 'yii2' . DIRECTORY_SEPARATOR . 'base' . DIRECTORY_SEPARATOR . 'Application.php';
    ...
    public static function setAlias()
    {
        ...
        $newAliasString = str_replace("'" . self::$bowerVendor . "'", "'" . self::$sourceBower . "'", self::$aliasBowerString);
        
        $file = str_replace(self::$aliasBowerString, $newAliasString, $file);
    ...
    public static function unsetAlias()
    {
        ...
        $aliasString = str_replace("'" . self::$bowerVendor . "'", "'" . self::$sourceBower . "'", self::$aliasBowerString);
        
        $file = str_replace($aliasString, self::$aliasBowerString, $file);
