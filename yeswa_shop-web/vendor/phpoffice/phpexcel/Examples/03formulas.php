...
echo date('H:i:s'), " Sum of Range #1 is ", $objPHPExcel->getActiveSheet()
    ->getCell('B5')
...
echo date('H:i:s'), " Average value of both Ranges is ", $objPHPExcel->getActiveSheet()
    ->getCell('B10')
    ->getCalculatedValue(), EOL;
