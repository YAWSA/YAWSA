...
class Infinite_Scroll_Presets
{
    ...
    public $ttl = 86000;
 // TTL of transient cache in seconds, 1 day = 86400 = 60*60*24
    public $keys = array(
        'theme',
        'contentSelector',
        'navSelector',
    ...
    function __construct(&$parent)
    {
        ...
        add_action('wp_ajax_infinite-scroll-edit-preset', array(
            &$this,
            'process_ajax_edit'
        ));
        add_action('wp_ajax_infinite-scroll-delete-preset', array(
            &$this,
            'process_ajax_delete'
        ));
        add_filter($this->parent->prefix . 'presets', array(
            &$this,
            'merge_custom_presets'
        ));
        add_filter($this->parent->prefix . 'options', array(
            &$this,
            'default_to_presets'
        ), 9);
        add_action($this->parent->prefix . 'refresh_cache', array(
            &$this,
            'get_presets'
        ));
    }
     ...
     * 
     * @param string $data
     *            the contents of the CSV (usually via wp_remote_get)
     * @param
     *            string the equivalent standard CSV
     */
     ...
     * 
     * @param
     *            string|array the CSV data, either as a string or as an array of lines
     ...
     * 
     * @param bool $all
     *            (optional) whether to include community selectors in output
     ...
     *            either the theme slug or the preset object
