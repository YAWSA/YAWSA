...
class Config
{
    ...
    /**
     * Gets the module instance by validating the module name.
     * The check is first done for a submodule of the same name
