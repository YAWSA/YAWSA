...
trait WidgetTrait
{
     ...
     * The following special data attributes will also be setup
     ...
     * @param integer $pos
     *            the position at which the JS script tag should be inserted in a page. The possible values
     *            are:
     ...
     * @param string $key
     *            the key that identifies the JS code block. If null, it will use `$js` as the key. If two JS
