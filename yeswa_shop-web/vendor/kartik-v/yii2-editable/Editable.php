...
HTML;
    ...
    /**
     * Other HTML5 input (e.g.
     * color, range, email etc.)
     */
    ...
    protected function initOptions()
    {
        ...
        if ($this->header == null) {
            ...
            $this->_popoverOptions['header'] = $this->preHeader . ($this->hasModel() ? $this->model->getAttributeLabel($attribute) : '');
        } else {
