...
class TwitterPlugin extends Widget
{
     ...
     * @see https://dev.twitter.com/web/embedded-timelines/list - `search`: string, the search hash tag, if you want to use embedded search timeline.
     * @see https://dev.twitter.com/web/embedded-timelines/search - `collectionId`: string, the collection identifier, if you want to use embedded collection timeline.
     * @see https://dev.twitter.com/web/embedded-timelines/collection - `collectionName`: string, the collection name, if you want to use embedded collection timeline.
    ...
    public function init()
    {
        ...
        if (! isset($this->noscript)) {
            $this->noscript = Yii::t('kvsocial', 'Please enable JavaScript on your browser to view the Twitter {pluginName} plugin correctly on this site.', [
                'pluginName' => Yii::t('kvsocial', str_replace('twitter-', '', $this->type))
            ]);
        }
        $this->registerAssets();
