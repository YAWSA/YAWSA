...
/**
 * Widget to render various Github buttons.
...
class GithubPlugin extends Widget
{
    ...
    public function init()
    {
        ...
        if (! isset($this->noscript)) {
            $this->noscript = Yii::t('kvsocial', 'Please enable JavaScript on your browser to view the Facebook {pluginName} plugin correctly on this site.', [
        ...
        $this->options['src'] = ltrim(Url::to([
            self::API
        ] + $this->settings), Url::to([
            '/'
        ]));
