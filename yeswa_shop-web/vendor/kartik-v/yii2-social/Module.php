...
class Module extends \yii\base\Module
{
     ...
     *
     * @param array $params
     *            the parameters to be set for the facebook session. If not set, will use the module level
     *            facebook settings.
     *            
     ...
     *            , if set to null the facebook object will be set to a null value. If set as an array,
     ...
     *            the permissions for the user to be authenticated by the login helper. Defaults to
     *            `['email', 'user_posts']`.
     * @param Facebook $fb
