...
final class Constants
{
    ...
    /**
     * Bad registration_id.
     * Sender should remove this registration_id.
     */
     ...
     * Include collapse key in the request.
     */
     ...
     * available.
     * Used only on JSON requests, as in plain text requests
     ...
     * an error.
     * Used only on JSON requests, as in plain text requests internal
