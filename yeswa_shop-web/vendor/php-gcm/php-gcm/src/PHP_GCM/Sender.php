...
class Sender
{
     ...
     *            to be sent, including the device's registration id.
     ...
     *
     * @param
     *            array unsentRegIds list of devices that are still pending an update.
     * @param
     *            array allResults map of status that will be updated.
     * @param
     *            MulticastResult multicastResult result of the last multicast sent.
     *            
