...
class AbstractParserTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->lexer = $lexer = new \JMS\Parser\SimpleLexer('/([0-9]+)|\s+|(.)/', array(
            0 => 'T_UNKNOWN',
            1 => 'T_INT',
            100 => 'T_PLUS',
            101 => 'T_MINUS'
            ...
            if ('+' === $value) {
                return array(
                    AbstractParserTest::T_PLUS,
                    $value
                );
            }
            if ('-' === $value) {
                return array(
                    AbstractParserTest::T_MINUS,
                    $value
                );
            }
