...
class RunCest
{
    ...
    {
        $I->executeCommand('run dummy --skip skipped --skip remote --skip remote_server --skip order --skip unit ' . '--skip powers --skip math --skip messages');
    ...
    public function runTestWithDataProviders(\CliGuy $I)
    {
        ...
        $I->seeInShellOutput('Test is triangle | "real triangle" (DataProvidersTest::testIsTriangle)');
