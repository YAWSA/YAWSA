	...
	<div class="container" id="page">
		<div class="form">
			<form id="login-form" action="/form/example1" method="post">
				...
				<div class="row">
					<label for="LoginForm_username" class="required">Username <span
				...
				<div class="row">
					<label for="LoginForm_password" class="required">Password <span
						class="required">*</span></label> <input
				...
				<div class="row rememberMe">
					<input id="ytLoginForm_rememberMe" type="hidden" value="0"
						...
						id="LoginForm_rememberMe" value="1" type="checkbox" /> <label
