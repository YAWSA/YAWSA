...
class WebDriverTest extends TestsForBrowsers
{
    ...
    public function testRawSelenium()
    {
        ...
        $this->module->executeInSelenium(function ($webdriver) {
            $webdriver->findElement(WebDriverBy::id('link'))
                ->click();
        });
    ...
    public function testKeys()
    {
        ...
        $this->module->pressKey('#name', [
            'ctrl',
            'a'
        ], WebDriverKeys::DELETE);
        $this->module->pressKey('#name', 'test', [
            'shift',
            '111'
        ]);
    ...
    public function testAppendFieldSelect()
    {
        ...
        $this->module->click('Submit');
        $form = data::get('form');
        $this->assertEmpty(array_diff($form['like'], [
            "eat",
            "code"
        ]));
    }
    ...
    public function testCreateCeptScreenshotFail()
    {
        ...
        $module = Stub::make(self::MODULE_CLASS, [
            'webDriver' => $fakeWd
        ]);
    ...
    public function testCreateCestScreenshotOnFail()
    {
        ...
        $cest = (new \Codeception\TestCase\Cest())->config('testClassInstance', new stdClass())->config('testMethod', 'login');
        $module->_failed($cest, new PHPUnit_Framework_AssertionFailedError());
    }

    public function testCreateTestScreenshotOnFail()
    {
        $test = Stub::make('\Codeception\TestCase\Test', [
            'getName' => 'testLogin'
        ]);
        $fakeWd = Stub::make(self::WEBDRIVER_CLASS, [
    ...
    public function testWebDriverWaits()
    {
        ...
        $module->waitForElementNotVisible([
            'id' => 'user'
        ]);
        $module->waitForElementNotVisible([
            'css' => '.user'
    ...
    public function testSessionSnapshots()
    {
        $this->notForPhantomJS();
        $this->module->amOnPage('/');
        $this->module->setCookie('PHPSESSID', '123456', [
            'path' => '/'
        ]);
