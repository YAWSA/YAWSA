...
class PhpBrowserRestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->phpBrowser->_setConfig(array(
            'url' => $url
        ));
    ...
    {
        $this->phpBrowser = Stub::make('\Codeception\Module\PhpBrowser', [
    ...
    public function testGet()
    {
        ...
        $this->module->seeResponseContainsJson(array(
            'name' => 'davert'
        ));
    ...
    public function testSendAbsoluteUrlGet()
    {
        ...
        $this->module->seeResponseCodeIs(200);
        $this->assertEquals('http://127.0.0.1:8010/rest/user/', $this->module->client->getHistory()
            ->current()
            ->getUri());
    }
    ...
    {
        $this->module->sendPOST('/rest/user/', array(
            'name' => 'john'
        ));
    ...
    public function testDontSeeInJson()
    {
        ...
        $this->module->seeResponseIsJson();
        $this->module->dontSeeResponseContainsJson(array(
            'name' => 'Davet'
        ));
        $this->module->dontSeeResponseContainsJson(array(
            'user' => array(
