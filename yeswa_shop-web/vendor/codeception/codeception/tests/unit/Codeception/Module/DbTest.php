...
class DbTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        self::$module->seeInDatabase('users', [
            'name' => 'davert'
        ]);
    }
    ...
    {
        self::$module->seeNumRecords(1, 'users', [
            'name' => 'davert'
        ]);
        self::$module->seeNumRecords(0, 'users', [
            'name' => 'davert',
            'email' => 'xxx@yyy.zz'
        ]);
        self::$module->seeNumRecords(0, 'users', [
    ...
    {
        self::$module->dontSeeInDatabase('users', [
            'name' => 'user1'
        ]);
    }
    ...
    {
        $email = self::$module->grabFromDatabase('users', 'email', [
            'name' => 'davert'
        ]);
    ...
    public function testHaveAndSeeInDatabase()
    {
        ...
        $user_id = self::$module->haveInDatabase('users', [
            'name' => 'john',
            'email' => 'john@jon.com'
        ]);
        $group_id = self::$module->haveInDatabase('groups', [
            'name' => 'john',
            'enabled' => false
        ]);
    ...
    public function testHaveInDatabaseWithCompositePrimaryKey()
    {
        ...
        self::$module->driver->executeQuery($insertQuery, [
            1,
            2,
            'test'
        ]);
        ...
        self::$module->seeInDatabase('composite_pk', [
            'group_id' => 1,
            'id' => 2,
            'status' => 'test'
        ]);
