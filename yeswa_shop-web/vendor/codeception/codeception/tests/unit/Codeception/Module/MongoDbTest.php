...
class MongoDbTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->userCollection->insert(array(
            'id' => 1,
    ...
    {
        $this->module->seeInCollection('users', array(
            'email' => 'miles@davis.com'
        ));
    }
    ...
    {
        $this->module->dontSeeInCollection('users', array(
            'email' => 'davert@davert.com'
        ));
    }

    public function testHaveAndSeeInCollection()
    {
        $this->module->haveInCollection('users', array(
            'name' => 'John',
    ...
    {
        $user = $this->module->grabFromCollection('users', array(
            'id' => 1
        ));
    ...
    public function testSeeNumElementsInCollection()
    {
        ...
        $this->module->seeNumElementsInCollection('users', 1, array(
            'email' => 'miles@davis.com'
        ));
        $this->module->seeNumElementsInCollection('users', 0, array(
            'name' => 'Doe'
        ));
    }
    ...
    public function testGrabCollectionCount()
    {
        ...
        $this->assertEquals(1, $this->module->grabCollectionCount('users', array(
            'id' => 3
        )));
    ...
    public function testSeeElementIsArray()
    {
        ...
        $this->module->seeElementIsArray('users', array(
            'id' => 4
        ), 'trumpets');
    }
    ...
    public function testSeeElementIsObject()
    {
        ...
        $this->module->seeElementIsObject('users', array(
            'id' => 6
        ), 'trumpet');
    }
    ...
    public function testUseDatabase()
    {
        ...
        $this->module->haveInCollection('stuff', array(
            'name' => 'Ashley',
            'email' => 'me@ashleyclarke.me'
        ));
        $this->module->seeInCollection('stuff', array(
            'name' => 'Ashley',
            'email' => 'me@ashleyclarke.me'
        ));
        $this->module->dontSeeInCollection('users', array(
