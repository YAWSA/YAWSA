...
abstract class TestsForWeb extends \Codeception\TestCase\Test
{
    ...
    {
        $this->setExpectedException('PHPUnit_Framework_AssertionFailedError', "No links containing text 'Codeception' were found in page /external_url");
        $this->module->amOnPage('/external_url');
    ...
    {
        $this->setExpectedException('PHPUnit_Framework_AssertionFailedError', "No links containing text 'Next' and URL '/fsdfsdf/' were found in page /external_url");
        $this->module->amOnPage('/external_url');
    ...
    {
        $this->setExpectedException('PHPUnit_Framework_AssertionFailedError', "Link containing text 'Next' was found in page /external_url");
        $this->module->amOnPage('/external_url');
    ...
    public function testSelectMultipleOptionsByText()
    {
        ...
        $this->module->selectOption('What do you like the most?', array(
            'Play Video Games',
            'Have Sex'
        ));
        $this->module->click('Submit');
    ...
    public function testSeeElementOnPage()
    {
        ...
        $this->module->dontSeeElement('input', [
            'id' => 'something-beyond'
        ]);
    ...
    public function testStrictLocators()
    {
        ...
        $this->module->seeElement([
            'css' => 'form.global_form_box'
        ]);
        $this->module->seeElement([
            'xpath' => \Codeception\Util\Locator::tabIndex(4)
        ]);
        $this->module->fillField([
            'name' => 'password'
        ], '123456');
        $this->module->amOnPage('/form/select');
        $this->module->selectOption([
            'name' => 'age'
        ], 'child');
        $this->module->amOnPage('/form/checkbox');
        $this->module->checkOption([
            'name' => 'terms'
        ]);
        $this->module->amOnPage('/');
        $this->module->seeElement([
    ...
    public function testExample4()
    {
        ...
        $this->module->click([
            'css' => '#register button[type="submit"]'
        ]);
