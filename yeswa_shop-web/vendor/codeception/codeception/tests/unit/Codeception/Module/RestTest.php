...
class RestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $connectionModule = Stub::make('\Codeception\Module\UniversalFramework', [
    ...
    public function testGrabDataFromResponseByJsonPath()
    {
        ...
        $this->assertEquals([
            'davert@mail.ua'
        ], $this->module->grabDataFromResponseByJsonPath('$.email'));
        // nested assoc array
        $this->assertEquals([
            'Kyiv'
        ], $this->module->grabDataFromResponseByJsonPath('$.address.city'));
        // nested index array
        $this->assertEquals([
            'DavertMik'
        ], $this->module->grabDataFromResponseByJsonPath('$.aliases[0]'));
    ...
    public function testSeeHeaders()
    {
        ...
        $this->assertEquals([
            'no-cache',
            'no-store'
        ], $this->module->grabHttpHeader('Cache-Control', false));
    }
    ...
    public function testJsonTypeMatches()
    {
        ...
        $this->module->seeResponseMatchesJsonType([
            'xxx' => 'string',
            'user_id' => 'integer:<10'
        ]);
        $this->module->dontSeeResponseMatchesJsonType([
            'xxx' => 'integer',
            'user_id' => 'integer:<10'
        ]);
    }
