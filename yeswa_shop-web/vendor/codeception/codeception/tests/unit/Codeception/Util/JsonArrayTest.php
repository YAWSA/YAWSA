...
class JsonArrayTest extends \Codeception\TestCase\Test
{
    ...
    {
        $this->assertTrue($this->jsonArray->containsArray([
            'name' => 'Davert'
        ]));
        $this->assertTrue($this->jsonArray->containsArray([
            'user' => [
    ...
    {
        $this->assertContains('<ticket><title>Bug should be fixed</title><user><name>Davert</name></user><labels></labels></ticket>', $this->jsonArray->toXml()
            ->saveXML());
    }
    ...
    public function testXmlArrayConversion2()
    {
        ...
        $this->assertContains('<tags>wed-dev</tags>', $jsonArray->toXml()
            ->saveXML());
    ...
    public function testJsonPathLocation()
    {
        ...
        $this->assertEquals([
            'Davert'
        ], $this->jsonArray->filterByJsonPath('$.ticket.user.name'));
    ...
    public function testInvalidXmlTag()
    {
        ...
        $this->assertContains($expectedXml, $jsonArray->toXml()
            ->saveXML());
    }
}
