...
class AnnotationTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals('null', Annotation::forClass(__CLASS__)->method('testMethodAnnotation')
            ->fetch('return'));
    }
    ...
    public function testMultipleClassAnnotations()
    {
        $this->assertEquals(array(
            'codeception',
            'tdd'
        ), Annotation::forClass(__CLASS__)->fetchAll('tag'));
    }
    ...
    public function testMultipleMethodAnnotations()
    {
        $this->assertEquals(array(
            '$var1',
            '$var2'
        ), Annotation::forClass(__CLASS__)->method('testMethodAnnotation')
            ->fetchAll('param'));
    }
}
