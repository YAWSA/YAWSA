...
class StubTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $dummy = Stub::makeEmpty('DummyClass', array(
            'helloWorld' => function () {
    ...
    {
        $dummy = Stub::makeEmptyExcept('DummyClass', 'getCheckMe', array(
            'checkMe' => 'checked!'
        ));
    ...
    {
        $dummy = Stub::makeEmptyExcept('DummyClass', 'getCheckMeToo', array(
            'checkMeToo' => 'checked!'
        ));
    ...
    {
        $dummy = Stub::make('DummyClass', array(
    ...
    {
        $dummy = Stub::copy($this->dummy, array(
            'checkMe' => 'checked!'
        ));
        $this->assertEquals('checked!', $dummy->getCheckMe());
        $dummy = Stub::copy($this->dummy, array(
    ...
    {
        $dummy = Stub::construct('DummyClass', array(
            'checkMe' => 'checked!'
        ));
    ...
    {
        $dummy = Stub::construct('DummyClass', array(), array(
            'helloWorld' => function () {
                return 'good bye world';
            }
        ));
    ...
    {
        $dummy = Stub::constructEmpty('DummyClass', array(
            'checkMe' => 'checked!'
        ));
    ...
    {
        $dummy = Stub::constructEmptyExcept('DummyClass', 'getCheckMe', array(
            'checkMe' => 'checked!'
        ));
    ...
    public function testStubsFromObject()
    {
        ...
        $this->assertInstanceOf('\PHPUnit_Framework_MockObject_MockObject', $dummy);
    ...
    {
        $mock = Stub::makeEmptyExcept('DummyClass', 'call', array(
            'targetMethod' => $stubMarshaler
        ), $this);
        $mock->goodByeWorld();
    ...
    {
        $dummy = Stub::constructEmpty('DummyClass', array(), array(
            'goodByeWorld' => $matcher
        ), $this);
    ...
    {
        $dummy = Stub::constructEmptyExcept('DummyClass', 'getCheckMe', array(), array(
            'goodByeWorld' => $matcher
        ), $this);
    ...
    {
        $dummy = Stub::make('DummyClass', array(
            'helloWorld' => Stub::consecutive('david', 'emma', 'sam', 'amy')
        ));
    ...
    {
        $tester = Stub::construct('MyClassWithPrivateProperties', [
            'name' => 'gamma'
        ], [
            'randomName' => 'chicken',
            't' => 'ticky2',
