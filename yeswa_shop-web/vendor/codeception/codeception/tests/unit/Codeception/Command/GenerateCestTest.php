...
class GenerateCestTest extends BaseCommandRunner
{
    ...
    public function testGenerateWithFullName()
    {
        $this->execute(array(
            'suite' => 'shire',
            'class' => 'HomeCanInclude12DwarfsCest.php'
        ));
    ...
    public function testGenerateWithSuffix()
    {
        $this->execute(array(
            'suite' => 'shire',
            'class' => 'HomeCanInclude12DwarfsCest'
        ));
    ...
    public function testCreateWithNamespace()
    {
        $this->execute(array(
            'suite' => 'shire',
            'class' => 'MiddleEarth\HallUnderTheHillCest'
        ));
