...
class GroupManagerTest extends \Codeception\TestCase\Test
{
    ...
    {
        $this->manager = new GroupManager([
            'important' => 'tests/data/test_groups'
        ]);
    ...
    {
        $this->manager = new GroupManager([
            'whitespace_group_test' => 'tests/data/whitespace_group_test'
        ]);
