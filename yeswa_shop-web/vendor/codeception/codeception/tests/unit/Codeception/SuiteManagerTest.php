...
class SuiteManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRun()
    {
        ...
        $this->suiteman->run($this->runner, new \PHPUnit_Framework_TestResult(), [
            'colors' => false,
            'steps' => true,
            'debug' => false
        ]);
    ...
    public function testFewTests()
    {
        ...
        $this->assertEquals(2, $this->suiteman->getSuite()
            ->count());
        
        $file = \Codeception\Configuration::dataDir() . 'SimpleWithNoClassCest.php';
        $this->suiteman->loadTests($file);
        $this->assertEquals(3, $this->suiteman->getSuite()
            ->count());
    }
    ...
    public function testAddCestWithEnv()
    {
        ...
        $this->assertEquals(3, $newSuiteMan->getSuite()
            ->count());
    }
    ...
    public function testGroupEventsAreFired()
    {
        ...
        $this->suiteman->run($this->runner, $result, [
            'silent' => true,
            'colors' => false,
            'steps' => true,
            'debug' => false
