...
class Laravel4 extends Framework implements ActiveRecord, PartedModule
{
    ...
    protected function checkStartFileExists()
    {
        ...
        if (! file_exists($startFile)) {
            throw new ModuleConfig($this, "Laravel bootstrap start.php file not found in $startFile.\n" . "Please provide a valid path to it using 'start' config param. ");
        }
    }
    ...
    {
        $domain = $this->app['router']->getRoutes()
            ->getByName($route)
            ->domain();
     ...
     *            The name of the command as displayed in the artisan command list
     * @param array $parameters
     *            An associative array of command arguments
     *            
     * @return string
     */
