...
class Phalcon1 extends Framework implements ActiveRecord, PartedModule
{
    ...
    /**
     * Registers a service in the services container and resolve it.
     * This record will be erased after the test.
     * Recommended to use for unit testing.
     *
     * ``` php
     * <?php
    ...
    public function seeCurrentRouteIs($routeName)
    {
        ...
        try {
            $this->seeCurrentUrlEquals($url->get([
                'for' => $routeName
            ], null, true));
        } catch (Exception $e) {
            $this->fail($e->getMessage());
