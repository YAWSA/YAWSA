...
class Facebook
{
    ...
    {
        $response = $this->executeFacebookRequest('POST', $this->appId . '/accounts/test-users', [
            'name' => $name,
            'installed' => true,
    ...
    {
        $response = $this->executeFacebookRequest('GET', '/me', $parameters = [], $testUserAccessToken);
    ...
    {
        $response = $this->executeFacebookRequest('GET', '/me/feed', $parameters = [], $testUserAccessToken);
    ...
    {
        $response = $this->executeFacebookRequest('GET', "/$placeId", $parameters = [], $testUserAccessToken);
    ...
    {
        $response = $this->executeFacebookRequest('POST', '/me/feed', $parameters, $testUserAccessToken);
