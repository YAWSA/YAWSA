...
EOF;
    ...
    public function produce()
    {
        ...
        return (new Template($this->template))->place('namespace', $namespace ? $namespace . '\\' : '')
    ...
    protected function addMethod(\ReflectionMethod $refMethod)
    {
        ...
        $methodTemplate = (new Template($this->methodTemplate))->place('module', $module)
        ...
        if (0 === strpos($refMethod->name, 'see')) {
            $type = 'Assertion';
            $body .= $methodTemplate->place('doc', $conditionalDoc)
        ...
        $body .= $methodTemplate->place('doc', $doc)
