...
class Cest extends CodeceptionTestCase implements ScenarioDriven, Descriptive, Reported, Configurable
{
    use Actor;
    use Dependencies;
    use ScenarioPrint;
    ...
    protected function executeContextMethod($context, $I)
    {
        ...
        throw new \LogicException("Method $context defined in annotation but does not exist in " . get_class($this->testClassInstance));
    }
