...
class Apns extends AbstractApnsGcm
{
    ...
    public function getClient()
    {
        if ($this->_client === null) {
            $this->_client = new \ApnsPHP_Push($this->environment == self::ENVIRONMENT_PRODUCTION ? \ApnsPHP_Push::ENVIRONMENT_PRODUCTION : \ApnsPHP_Push::ENVIRONMENT_SANDBOX, $this->pemFile);
     ...
     * @param string $token
     * @param string $text
     *            a message in sending push notification
     * @param array $payloadData
     *            The payload contains information about how the system should alert the user as well as any custom data you provide
     * @param array $args
     *            optional additional information in sending a message
