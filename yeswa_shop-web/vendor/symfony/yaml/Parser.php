...
class Parser
{
     ...
     * @param int|null $totalNumberOfLines
     *            The overall number of lines being parsed
     * @param int[] $skippedLineNumbers
     *            Number of comment lines that have been skipped by the parser
     */
