...
class MapTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertTrue($this->map->get('asdf')
            ->isEmpty());
        $this->map->set('asdf', 'foo');
        $this->assertEquals('foo', $this->map->get('asdf')
            ->get());
        
        $this->assertEquals('bar', $this->map->get('foo')
            ->get());
        $this->map->set('foo', 'asdf');
        $this->assertEquals('asdf', $this->map->get('foo')
            ->get());
    }
    ...
    {
        $this->assertTrue($this->map->get('foo')
            ->isDefined());
        $this->assertEquals('bar', $this->map->remove('foo'));
        $this->assertFalse($this->map->get('foo')
            ->isDefined());
    }
    ...
    public function testFirst()
    {
        $this->assertEquals(array(
            ...
            ->get());
        $this->map->clear();
        $this->assertTrue($this->map->first()
            ->isEmpty());
    }
