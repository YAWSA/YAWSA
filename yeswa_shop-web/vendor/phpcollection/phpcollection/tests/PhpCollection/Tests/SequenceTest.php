...
class SequenceTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertSame(0, $this->seq->first()
            ->get());
    ...
    public function testDrop()
    {
        ...
        $this->assertSame(array(
            ...
            ->all());
        $this->assertSame(array(), $this->seq->drop(9999)
            ->all());
    }
    ...
    public function testDropRight()
    {
        $this->assertSame(array(
            ...
            $this->a,
            $this->b
        ), $this->seq->dropRight(1)
            ->all());
        $this->assertSame(array(
            0,
            $this->a
        ), $this->seq->dropRight(2)
            ->all());
        $this->assertSame(array(), $this->seq->dropRight(9999)
            ->all());
    }
