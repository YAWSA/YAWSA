...
class AbstractSequence extends AbstractCollection implements \IteratorAggregate, SequenceInterface
{
     ...
     *            receives the element and must return true (= keep) or false (= remove).
     *            
     ...
     *
     * @param callable $callable
     *            receives the element and must return true (= remove) or false (= keep).
     *            
     * @return AbstractSequence
     */
     ...
     *
     * @param callable $callable
     *            receives elements of this sequence as first argument, and returns true/false.
     *            
     * @return Sequence
     */
