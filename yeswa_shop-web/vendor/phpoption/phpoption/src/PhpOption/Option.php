...
abstract class Option implements IteratorAggregate
{
     ...
     *            The value which should be considered "None"; null
     *            by default.
     *            
     * @return Option
     */
     ...
     * @param null $noneValue
     *            used when $value is mixed or Closure, for None-check
     *            
     * @return Option
     */
     ...
     * @param callable $callable
     *            function(initialValue, callable): result
     *            
     * @return mixed
     */
     ...
     * @param mixed $initialValue
     * @param callable $callable
     *            function(callable, initialValue): result
     *            
     * @return mixed
     */
