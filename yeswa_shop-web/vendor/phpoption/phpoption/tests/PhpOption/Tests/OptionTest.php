...
class OptionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFromArraysValue()
    {
        ...
        $this->assertEquals(None::create(), Option::fromArraysValue(array(
            'foo' => 'bar'
        ), 'baz'));
        $this->assertEquals(None::create(), Option::fromArraysValue(array(
            'foo' => null
        ), 'foo'));
        $this->assertEquals(new Some('foo'), Option::fromArraysValue(array(
            'foo' => 'foo'
        ), 'foo'));
    }
    ...
    public function testOrElse()
    {
        ...
        $this->assertEquals('a', $a->orElse($b)
            ->get());
    }
    ...
    public function testOrElseWithNoneAsFirst()
    {
        ...
        $this->assertEquals('b', $a->orElse($b)
            ->get());
    }
    ...
    public function testOrElseWithMultipleAlternatives()
    {
        ...
        $this->assertEquals('foo', $a->orElse($returns)
            ->orElse($throws)
            ->get());
    }
}