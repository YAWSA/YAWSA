...
class InfiniteScrollPager extends Widget
{
    ...
    protected function initializeInfiniteScrollPlugin()
    {
        ...
        $pluginOptions['loading'] = array_filter(ArrayHelper::getValue($this->pluginOptions, 'loading', null)); // Removing null entries
        ...
        $this->view->registerJs("$('" . $this->pluginOptions['contentSelector'] . "').infinitescroll(" . $pluginOptions . ", " . $contentLoadedCallback . ");", View::POS_END, $this->widgetId . '-infinite-scroll');
    }
}
