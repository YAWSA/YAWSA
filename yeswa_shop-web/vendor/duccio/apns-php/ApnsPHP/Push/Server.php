...
class ApnsPHP_Push_Server extends ApnsPHP_Push
{
     ...
     *
     * @param $nProcesses @type
     *            integer Processes to start up.
     */
     ...
     *
     * @param $nQueueKey @type
     *            integer The key of the queue stored in the shared
     *            memory.
     * @param $nProcess @type
     *            integer @optional The process cardinal number.
     ...
     *
     * @param $nQueueKey @type
     *            integer The key of the queue to store in the shared
     *            memory.
     * @param $nProcess @type
     *            integer @optional The process cardinal number.
     * @param $aQueue @type
     *            array @optional The queue to store into shared memory.
