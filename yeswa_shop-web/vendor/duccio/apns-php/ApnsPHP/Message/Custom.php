...
class ApnsPHP_Message_Custom extends ApnsPHP_Message
{
     ...
     *
     * @param $sActionLocKey @type
     *            string @optional The "View" button title, default
     *            empty string.
     */
     ...
     *
     * @param $sLocKey @type
     *            string The alert-message string.
     */
     ...
     *
     * @param $aLocArgs @type
     *            array The variable string values.
     */
     ...
     *
     * @param $sLaunchImage @type
     *            string The filename of an image file.
     */
     ...
     *
     * @param $sTitle @type
     *            string The title displayed in the short look notification
     */
