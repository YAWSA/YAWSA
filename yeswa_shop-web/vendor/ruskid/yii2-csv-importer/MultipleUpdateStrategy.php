...
/**
 * Update from CSV.
 * This will create|update rows of an ActiveRecord table.
...
class MultipleUpdateStrategy extends MultipleImportStrategy implements ImportInterface
{
    ...
    /**
     * Will multiple import|update data into table.
     * WARNING: this function deletes $data content to save memory.
     * 
     * @param array $data
    ...
    public function updateRecord($row, $values)
    {
        return Yii::$app->db->createCommand()
            ->update($this->tableName, $values, $row)
            ->execute();
    }
}
