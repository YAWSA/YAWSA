...
<div>
	<p>
		<strong>Notice:</strong> HTML has been scrubbed for your safety. If
		you would like to see the original, turn off WYSIWYG mode (consult
...
<?php
	...
	<p>
		<strong>HTML input</strong> is enabled. Make sure you escape all HTML
		and angled brackets with
		<code>&amp;lt;</code>
		and
		<code>&amp;gt;</code>
		.
    ...
    if ($config->get('AutoFormat.AutoParagraph')) {
        ?><p>
		<strong>Auto-paragraphing</strong> is enabled. Double newlines will be
		converted to paragraphs; for single newlines, use the
		<code>pre</code>
		tag.
	</p><?php
    }
    ...
    ?><p>
		<strong>Allowed tags:</strong> <?php
    echo $allowed_text;
    ?>.</p><?php
    ?>
    </p>
	<p>
		For inputting literal code such as HTML and PHP for display, use CDATA
		tags to auto-escape your angled brackets, and
		<code>pre</code>
...
<em>Place code here</em>
	...
	<p>Power users, you can hide this notice with:
