...
foreach ($raw_files as $file) {
    ...
    if (! $ok)
        continue; // rm excluded directories
    if (in_array($file, $exclude_files))
        continue; // rm excluded files
    $files[] = $file;
}
echo "done!\n";
 ...
 * @return array Lookup array of files the file is dependent on, sorted accordingly.
 */
