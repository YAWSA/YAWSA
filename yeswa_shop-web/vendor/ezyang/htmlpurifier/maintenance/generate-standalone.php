 ...
 * This is usually called during the
 * release process.
 */
 ...
 * 
 * @param string $text
 *            PHP source code to replace includes from
 */
 ...
 * 
 * @param string $text
 *            Text to have leading PHP tag from
 */
...
/**
 *
 * @param $matches preg_replace_callback
 *            matches array, where index 1
...
$contents = str_replace(
    ...
    "define('HTMLPURIFIER_PREFIX', realpath(dirname(__FILE__) . '/..'));", "define('HTMLPURIFIER_PREFIX', dirname(__FILE__) . '/standalone');
