...
class ScrollPager extends Widget
{
    ...
    public function run()
    {
        ...
        $initString = empty($this->overflowContainer) ? "var {$this->id}_ias = jQuery.ias({$pluginSettings});" : "var {$this->id}_ias = jQuery('{$this->overflowContainer}').ias({$pluginSettings});";
     ...
     *
     * @param array $config
     *            jQuery IAS extensions definition.
     ...
     *
     * @param array $config
     *            jQuery IAS event handlers definition.
     ...
     *            Single or multiple extensions names.
