...
abstract class Mutex extends Component
{
     ...
     * @param int $timeout
     *            time (in seconds) to wait for lock to be released. Defaults to zero meaning that method will return
     ...
     * This method will return false in case the lock was not found.
     * 
     * @param string $name
