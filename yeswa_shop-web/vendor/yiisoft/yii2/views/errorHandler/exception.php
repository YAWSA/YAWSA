...
<style type="text/css">
/* reset */
html, body, div, span, h1, h2, h3, h4, h5, h6, p, pre, a, code, em, img,
	strong, b, i, ul, li {
	margin: 0;
	padding: 0;
	border: 0;
...
<body>
	...
	<div class="footer">
		...
		<p>
			<a href="http://yiiframework.com/">Yii Framework</a>/<?= $handler->createFrameworkVersionLink() ?></p>
	</div>
