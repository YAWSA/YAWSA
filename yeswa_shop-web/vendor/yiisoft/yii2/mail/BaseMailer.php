 ...
 *
 * @see BaseMessage For more details and usage information on BaseMailer, see the [guide article on mailing](guide:tutorial-mailing).
 *     
...
abstract class BaseMailer extends Component implements MailerInterface, ViewContextInterface
{
     ...
     *            view instance or its array configuration that will be used to
     ...
     * 
     * @param string $view
     *            the view name or the [path alias](guide:concept-aliases) of the view file.
     * @param array $params
     *            the parameters (name-value pairs) that will be extracted and made available in the view file.
     * @param string|bool $layout
     *            layout view name or [path alias](guide:concept-aliases). If false, no layout will be applied.
