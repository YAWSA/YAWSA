...
class Theme extends Component
{
     ...
     *
     * @param string $url
     *            the base URL or [path alias](guide:concept-aliases) for this theme. All resources of this theme are considered
     *            to be under this base URL.
     */
     ...
     *
     * @param string $path
     *            the root path or [path alias](guide:concept-aliases) of this theme. All resources of this theme are located
