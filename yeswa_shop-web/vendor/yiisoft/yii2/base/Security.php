...
class Security extends Component
{
     ...
     *            the random salt
     * @param string $info
     *            optional info to bind the derived key material to application-
     *            and context-specific information, e.g. a user ID or API version, see
     *            [RFC 5869](https://tools.ietf.org/html/rfc5869)
     * @param int $length
     *            length of the output key in bytes. If 0, the output key is
     ...
     *            the number of iterations of the hash algorithm. Set as high as
     ...
     * @param string $key
     *            the secret key to be used for generating hash. Should be a secure
     *            cryptographic key.
     * @param bool $rawHash
     *            whether the generated hash value is in raw binary format. If false, lowercase
     ...
     * 
     * @param string $data
     *            the data to be validated. The data must be previously
     *            generated by [[hashData()]].
     * @param string $key
     *            the secret key that was previously used to generate the hash for the data in [[hashData()]].
     *            function to see the supported hashing algorithms on your system. This must be the same
     *            as the value passed to [[hashData()]] when generating the hash for the data.
     * @param bool $rawHash
     *            this should take the same value as when you generate the data using [[hashData()]].
