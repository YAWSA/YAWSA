...
class View extends Component
{
     ...
     *            the context to be assigned to the view and can later be accessed via [[context]]
     ...
     * 
     * @param string $view
     *            the view name or the [path alias](guide:concept-aliases) of the view file. Please refer to [[render()]]
     ...
     *            the parameter array passed to the [[render()]] method.
     * @param string $output
     *            the rendering result of the view file. Updates to this parameter
     ...
     *            whether to render the block content in place.
     ...
     *
     * @param string $viewFile
     *            the view file that will be used to decorate the content enclosed by this widget.
