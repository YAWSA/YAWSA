...
class Module extends ServiceLocator
{
     ...
     * 
     * @param string $path
     *            the root directory of the module. This can be either a directory name or a [path alias](guide:concept-aliases).
     ...
     * 
     * @param string $path
     *            the root directory or [path alias](guide:concept-aliases) of layout files.
     * @throws InvalidParamException if the directory is invalid
     */
    ...
    public function getModule($id, $load = true)
    {
        ...
        if (isset($this->_modules[$id])) {
            if ($this->_modules[$id] instanceof self) {
                ...
                /* @var $module Module */
                $module = Yii::createObject($this->_modules[$id], [
                    $id,
                    $this
                ]);
     ...
     * @param string $id
     *            module ID.
     * @param Module|array|null $module
     *            the sub-module to be added to this module. This can
    ...
    /**
     *
     * {@inheritdoc} Since version 2.0.13, if a component isn't defined in the module, it will be looked up in the parent module.
