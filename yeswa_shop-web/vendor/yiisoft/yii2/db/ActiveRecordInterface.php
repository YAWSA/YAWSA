...
interface ActiveRecordInterface extends StaticInstanceInterface
{
     ...
     *            attribute values (name-value pairs) to be saved for the record.
     *            Unlike [[update()]] these are not going to be validated.
     * @param array $condition
     *            the condition that matches the records that should get updated.
     ...
     *
     * @param array $condition
     *            the condition that matches the records that should get deleted.
     *            Please refer to [[QueryInterface::where()]] on how to specify this parameter.
     *            An empty condition will match all records.
     ...
     *            whether to perform validation (calling [[\yii\base\Model::validate()|validate()]])
