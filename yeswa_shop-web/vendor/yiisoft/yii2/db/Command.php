...
class Command extends Component
{
     ...
     * 
     * @param int $duration
     *            the number of seconds that query result of this command can remain valid in the cache.
     ...
     * 
     * @param int $fetchMode
     *            the result fetch mode. Please refer to [PHP manual](http://www.php.net/manual/en/function.PDOStatement-setFetchMode.php)
     ...
     * 
     * @param int $fetchMode
     *            the result fetch mode. Please refer to [PHP manual](http://php.net/manual/en/pdostatement.setfetchmode.php)
     *            for valid fetch modes. If this parameter is null, the value set in [[fetchMode]] will be used.
     ...
     * @param array|\yii\db\Query $columns
