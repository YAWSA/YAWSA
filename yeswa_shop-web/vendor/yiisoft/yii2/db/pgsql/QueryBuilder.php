...
class QueryBuilder extends \yii\db\QueryBuilder
{
     ...
     *            whether to make this a UNIQUE index constraint. You can pass `true` or [[INDEX_UNIQUE]] to create
     ...
     *            the column data (name => value) to be saved into the table or instance
