...
abstract class Target extends Component
{
     ...
     *            log messages to be processed. See [[Logger::messages]] for the structure
     *            of each message.
     * @param bool $final
     ...
     * @param int $levels
     *            the message levels to filter by. This is a bitmap of
     ...
     *            a boolean value or a callable to obtain the value from.
