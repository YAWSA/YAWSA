...
interface CacheInterface extends \ArrayAccess
{
     ...
     *
     * @param mixed $key
     *            a key identifying the value to be cached. This can be a simple string or
     *            a complex data structure consisting of factors representing the key.
     * @param mixed $value
     *            the value to be cached
     * @param int $duration
     *            default duration in seconds before the cache will expire. If not set,
     ...
     * @param Dependency $dependency
     *            dependency of the cached items. If the dependency changes,
     ...
     * 
     * @param mixed $key
     *            a key identifying the value to be deleted from cache. This can be a simple string or
     *            a complex data structure consisting of factors representing the key.
