...
class FileCache extends Cache
{
     ...
     * @param string $value
     *            the value to be cached. Other types (If you have disabled [[serializer]]) unable to get is
     *            correct in [[getValue()]].
     * @param int $duration
     ...
     *            whether to removed expired cache files only.
     ...
     * @param bool $expiredOnly
     *            whether to only remove expired cache files. If false, all files
