...
class Session extends Component implements \IteratorAggregate, \ArrayAccess, \Countable
{
     ...
     * 
     * @param string $value
     *            the session name for the current session, must be an alphanumeric string.
     ...
     * 
     * @param string $value
     *            the current session save path. This can be either a directory name or a [path alias](guide:concept-aliases).
     ...
     * @param bool $delete
     *            whether to delete this flash message right after this method is called.
     ...
     *
     * @param bool $delete
     *            whether to delete the flash messages right after this method is called.
     ...
     * 
     * @param string $key
     *            the key identifying the flash message. Note that flash messages
     *            and normal session variables share the same name space. If you have a normal
     *            session variable using the same name, its value will be overwritten by this method.
     * @param mixed $value
     *            flash message
     * @param bool $removeAfterAccess
     *            whether the flash message should be automatically removed only if
