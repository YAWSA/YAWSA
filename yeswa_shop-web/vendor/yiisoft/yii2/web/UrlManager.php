...
class UrlManager extends Component
{
     ...
     *
     * @param array $rules
     *            the new rules to be added. Each array element represents a single rule declaration.
     ...
     * 
     * @param array $rules
     *            the rule declarations. Each array element represents a single rule declaration.
     ...
     *            use a string to represent a route (e.g. `site/index`),
    ...
    {
        return        // if rule does not provide info about create status, we cache it every time to prevent bugs like #13350
     ...
     *            the scheme to use for the URL (either `http`, `https` or empty string
