...
class MultipartFormDataParser extends BaseObject implements RequestParserInterface
{
    ...
    /**
     * Adds value to the array by input name, e.g.
     * `Item[name]`.
     * 
     * @param array $array
     *            array which should store value.
     * @param string $name
    ...
    /**
     * Adds file info to the uploaded files array by input name, e.g.
     * `Item[file]`.
     * 
     * @param array $files
