...
class UploadedFile extends BaseObject
{
     ...
     *            the attribute name. The attribute name may contain array indexes.
     ...
     * 
     * @param string $key
     *            key for identifying uploaded file: class name and sub-array indexes
     * @param mixed $names
     *            file names provided by PHP
     * @param mixed $tempNames
     *            temporary file names provided by PHP
     * @param mixed $types
     *            file types provided by PHP
     * @param mixed $sizes
