...
class Request extends \yii\base\Request
{
    ...
    /**
     * Returns the method of the current request (e.g.
    ...
    /**
     * Returns POST parameter with a given name.
     * If name isn't specified, returns an array of all POST parameters.
     *
     * @param string $name
     *            the parameter name
     * @param mixed $defaultValue
    ...
    /**
     * Returns GET parameter with a given name.
     * If name isn't specified, returns an array of all GET parameters.
     *
     * @param string $name
     *            the parameter name
     * @param mixed $defaultValue
     ...
     * 
     * @param array $value
     *            the content types that are acceptable by the end user. They should
     ...
     *
     * @param array $value
     *            the languages that are acceptable by the end user. They should
     *            be ordered by the preference level.
     */
     ...
     *            a list of the languages supported by the application. If this is empty, the current
...
strpos($normalizedLanguage, $acceptableLanguage . '-') === 0) // en-us==en
{
     ...
     *
     * @param string $clientSuppliedToken
