...
class UrlRule extends BaseObject implements UrlRuleInterface
{
     ...
     *
     * @param bool $allowAppendSlash
     *            Defines position of slash in the param pattern in [[$pattern]].
    ...
    public function parseRequest($manager, $request)
    {
        ...
        if ($normalized) {
            ...
            return $this->getNormalizer($manager)->normalizeRoute([
                $route,
                $params
            ]);
        }
    ...
    /**
     * Trim slashes in passed string.
     * If string begins with '//', two slashes are left as is
