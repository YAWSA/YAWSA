...
class UniqueValidator extends Validator
{
     ...
     *            the name of the ActiveRecord class that should be used to validate the uniqueness
     *            of the current attribute value.
     * @param array $conditions
     *            conditions, compatible with [[\yii\db\Query::where()|Query::where()]] key-value format.
     * @param Model $model
     *            the data model to be validated
     *            
     ...
     *
     * @param ActiveRecordInterface $targetClass
     *            the name of the ActiveRecord class that should be used to validate
     ...
     *
     * @param string|array $targetAttribute
     *            the name of the [[\yii\db\ActiveRecord|ActiveRecord]] attribute that
     ...
     *            the name of the attribute to be validated in the $model
     *            
     ...
     * @param array $conditions
     *            array of condition, keys to be modified
     * @param null|string $alias
     *            set empty string for no apply alias. Set null for apply primary table alias
     * @return array
     */
