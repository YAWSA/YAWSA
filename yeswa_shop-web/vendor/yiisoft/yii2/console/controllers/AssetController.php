...
class AssetController extends Controller
{
     ...
     * 
     * @param \yii\web\AssetManager|array $assetManager
...
EOD;
     ...
     * 
     * @param string $circularDependencyName
     *            name of the bundle, which have circular dependency
     * @param array $registered
     *            list of bundles registered while detecting circular dependency.
