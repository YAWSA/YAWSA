...
EOD;
     ...
     *            the path or alias of the configuration file.
    ...
    public function actionExtract($configFile = null)
    {
        ...
        if (in_array($this->config['format'], [
            'php',
            'po'
        ])) {
...
EOD;
    ...
    protected function initConfig($configFile)
    {
        ...
        if (empty($this->config['format']) || ! in_array($this->config['format'], [
            'php',
            'po',
            'pot',
            'db'
