...
class BaseUrl
{
     ...
     *            use a string to represent a route (e.g. `index`, `site/index`),
     ...
     * Absolute routes are staying as is
     ...
     *            the URL to process
     * @param string $scheme
     *            the URI scheme used in URL (e.g. `http` or `https`). Use empty string to
     ...
     *            the URL to remember. Please refer to [[to()]] for acceptable formats.
     *            If this parameter is not specified, the currently requested URL will be used.
     * @param string $name
     *            the name associated with the URL to be remembered. This can be used
     ...
     *
     * @param string $name
     *            the named associated with the URL that was remembered previously.
     ...
     *
     * @param array $params
     *            an associative array of parameters that will be merged with the current GET parameters.
