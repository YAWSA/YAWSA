...
class BaseFileHelper
{
     ...
     *            the target language that the file should be localized to.
     *            If not set, the value of [[\yii\base\Application::language]] will be used.
     * @param string $sourceLanguage
     *            the language that the original file is in.
     ...
     *            name of the optional magic database file (or alias), usually something like `/path/to/magic.mime`.
     ...
     *            the file name.
     * @param string $magicFile
     *            the path (or alias) of the file that contains all available MIME type information.
     ...
     * @param array $options
     *            the filtering options. See [[findFiles()]] for explanations of
