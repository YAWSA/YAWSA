...
class BaseConsole
{
     ...
     *
     * @param bool $refresh
     *            whether to force checking and not re-use cached size value.
     ...
     * @param bool $refresh
     *            whether to force refresh of screen size.
     ...
     *            optional width of the progressbar. This can be an integer representing
     ...
     *
     * @param string|bool $remove
     *            This can be `false` to leave the progress bar on screen and just print a newline.
     ...
     *            whether to keep the prefix that has been specified for the progressbar when progressbar
