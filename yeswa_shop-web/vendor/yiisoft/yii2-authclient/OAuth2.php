...
abstract class OAuth2 extends BaseOAuth
{
    ...
    /**
     * Applies client credentials (e.g.
     * [[clientId]] and [[clientSecret]]) to the HTTP request instance.
     ...
     * @param string $username
     * @param \yii\authclient\signature\BaseMethod|array $signature
     *            signature method or its array configuration.
