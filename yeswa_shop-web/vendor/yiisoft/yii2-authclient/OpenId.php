...
class OpenId extends BaseClient
{
     ...
     *            base URL.
     * @param string|array $additionalUrl
     ...
     * @param string $matchAttributeValue
    ...
    protected function buildAuthUrlV1($serverInfo)
    {
        ...
        return $this->buildUrl($serverInfo['url'], [
    ...
    /**
     * Gets SREG attributes provided by OP.
     ...
     * Should be used only after successful validation.
