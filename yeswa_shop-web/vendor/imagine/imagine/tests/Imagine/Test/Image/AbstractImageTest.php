...
abstract class AbstractImageTest extends ImagineTestCase
{
    ...
    public function testCopyResizedImageToImage()
    {
        ...
        $image->paste($image->copy()
            ->resize($size->scale(0.5))
            ->flipVertically(), new Center($size));
    }
    ...
    public function testCreateTransparentGradient()
    {
        ...
        $image->paste($factory->create($size, new Color('ff0'))
            ->applyMask($factory->create($size)
            ->fill(new Horizontal($image->getSize()
            ->getWidth(), new Color('fff'), new Color('000')))), new Point(0, 0));
    ...
    public function testMask()
    {
        ...
        $size = $factory->open('tests/Imagine/Fixtures/mask.png')->getSize();
    ...
    {
        $this->assertEquals(1, count($this->getMonoLayeredImage()
            ->layers()));
    }
    ...
    public function testCountAMultiLayeredImage()
    {
        ...
        $this->assertGreaterThan(1, count($this->getMultiLayeredImage()
            ->layers()));
    }
