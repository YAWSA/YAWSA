...
abstract class AbstractDrawerTest extends ImagineTestCase
{
    ...
    public function testDrawASmileyFace()
    {
        ...
        $canvas->save('tests/Imagine/Fixtures/smiley.png', array(
            'quality' => 100
        ));
    ...
    public function testDrawAnEllipse()
    {
        ...
        $canvas->draw()->ellipse(new Center($canvas->getSize()), new Box(300, 200), new Color('fff'), true);
        
        $canvas->save('tests/Imagine/Fixtures/ellipse.png', array(
            'quality' => 100
        ));
    ...
    public function testDrawAPieSlice()
    {
        ...
        $canvas->draw()->pieSlice(new Point(200, 150), new Box(100, 200), 45, 135, new Color('fff'), true);
    ...
    public function testDrawAChord()
    {
        ...
        $canvas->draw()->chord(new Point(200, 150), new Box(100, 200), 45, 135, new Color('fff'), true);
    ...
    public function testDrawAnArc()
    {
        ...
        $canvas->draw()->arc(new Center($size), $size->scale(0.5), 0, 180, new Color('fff'));
    ...
    public function testDrawText()
    {
        ...
        $canvas->draw()->text('Bulat', $font, new Point(0, 0), 135);
        ...
        $canvas->draw()->text('Bulat', $font, new Point(24, 24));
        ...
        $canvas->draw()->text('Bulat', $font, new Point(18, 18));
        ...
        $canvas->draw()->text('Bulat', $font, new Point(12, 12));
