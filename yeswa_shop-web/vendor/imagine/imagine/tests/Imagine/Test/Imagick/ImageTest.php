...
class ImageTest extends AbstractImageTest
{
    ...
    public function testImageResizeUsesProperMethodBasedOnInputAndOutputSizes()
    {
        ...
        $image->resize(new \Imagine\Image\Box(1500, 750))->save('tests/Imagine/Fixtures/resize/large.png');
        
        $image->resize(new \Imagine\Image\Box(100, 50))->save('tests/Imagine/Fixtures/resize/small.png');
