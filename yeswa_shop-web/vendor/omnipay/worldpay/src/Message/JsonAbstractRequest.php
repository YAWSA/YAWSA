...
abstract class JsonAbstractRequest extends AbstractRequest
{
     ...
     *
     * @param mixed $data
     *            The data to encode and send to the API endpoint
     *            
    ...
    public function sendRequest($data)
    {
        ...
        $httpRequest = $this->httpClient->createRequest($this->getHttpMethod(), $this->getEndpoint(), null, json_encode($data));
        
        $httpResponse = $httpRequest->setHeader('Authorization', $this->getServiceKey())
