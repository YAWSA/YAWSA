...
class SecureXMLResponse extends AbstractResponse
{
    ...
    public function isSuccessful()
    {
        ...
        if ((string) $this->data->Status->statusCode !== '000' || ($this->hasTransaction() && (string) $this->data->Payment->TxnList->Txn->approved !== 'Yes')) {
            return false;
        }
    ...
    {
        return $this->hasTransaction() ? (string) $this->data->Payment->TxnList->Txn->responseCode : (string) $this->data->Status->statusCode;
    }
    ...
    {
        return $this->hasTransaction() ? (string) $this->data->Payment->TxnList->Txn->responseText : (string) $this->data->Status->statusDescription;
    }
    ...
    {
        return $this->hasTransaction() ? (string) $this->data->Payment->TxnList->Txn->txnID : null;
    }
    ...
    {
        return $this->hasTransaction() ? (string) $this->data->Payment->TxnList->Txn->settlementDate : null;
    }
}
