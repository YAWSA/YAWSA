...
class ServerTokenRegistrationCompleteRequestTest extends TestCase
{
    ...
    public function testCorrectDataUponSuccessfulSagePayRequest()
    {
        ...
        $signature = $this->generateSignature('F955C22E-F67B-4DA3-8EA3-6DAC68FA59D2', $this->successDetails['VendorTxCode'], 'OK', $this->successDetails['Vendor'], $expectedToken, $this->successDetails['SecurityKey']);
