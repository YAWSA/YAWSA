...
class ServerCompleteAuthorizeResponse extends Response
{
     ...
     *
     * @param
     *            string URL to forward the customer to. Note this is different to your standard
     ...
     *
     * @param
     *            string URL to foward the customer to. Note this is different to your standard
     *            return controller action URL.
     * @param
     ...
     *
     * @param
     *            string The status to send to Sage Pay, either OK, INVALID or ERROR.
     * @param
     *            string URL to forward the customer to. Note this is different to your standard
     *            return controller action URL.
     * @param
