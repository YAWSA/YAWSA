...
class ServerNotifyResponse extends Response
{
     ...
     *
     * @param
     *            string URL to forward the customer to.
     * @param
     *            string Optional human readable reasons for accepting the transaction.
     */
     ...
     *
     * @param
     *            string URL to foward the customer to.
     * @param
     *            string Optional human readable reasons for not accepting the transaction.
     */
     ...
     * 
     * @param
     *            boolean true to exit; false to not exit.
     */
     ...
     *
     * @param
     *            string The status to send to Sage Pay, one of static::RESPONSE_STATUS_*
     * @param
     *            string URL to forward the customer to.
     * @param
     *            string Optional human readable reasons for this response.
     */
