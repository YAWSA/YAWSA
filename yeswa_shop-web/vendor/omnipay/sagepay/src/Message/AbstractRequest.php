...
abstract class AbstractRequest extends \Omnipay\Common\Message\AbstractRequest
{
     ...
     *
     * @param string $value
     *            ASCII alphanumeric and spaces, max 200 characters.
     */
     ...
     *
     * @param bool|int $storeToken
     *            0 = The Token will be deleted from the SagePay database if
...
':' . $basketItem->getQuantity() . // Quantity
            ...
            ':' . number_format($basketItem->getPrice(), 2, '.', '') . ':0.00' . // Item tax
                      // Item total
