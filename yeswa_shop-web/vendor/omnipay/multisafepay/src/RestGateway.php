...
class RestGateway extends AbstractGateway
{
    ...
    {
        return $this->createRequest('Omnipay\MultiSafepay\Message\RestFetchPaymentMethodsRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('Omnipay\MultiSafepay\Message\RestFetchIssuersRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('Omnipay\MultiSafepay\Message\RestFetchTransactionRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('Omnipay\MultiSafepay\Message\RestRefundRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('Omnipay\MultiSafepay\Message\RestPurchaseRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('Omnipay\MultiSafepay\Message\RestCompletePurchaseRequest', $parameters);
    }
}
