...
class PurchaseRequest extends AbstractRequest
{
    ...
    {
        $httpResponse = $this->httpClient->post($this->getEndpoint(), $this->getHeaders(), $data->asXML())
            ->send();
    ...
    {
        return md5($this->getAmountInteger() . $this->getCurrency() . $this->getAccountId() . $this->getSiteId() . $this->getTransactionId());
    }
}
