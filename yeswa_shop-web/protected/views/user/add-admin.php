...
?>
			<h3 class="text-center mar-tp-11">Admin Registration Form</h3>


					<div class="row">
						<div class="col-sm-12"></div>
						<?=$form->field ( $model, 'full_name', [ 'template' => '<div class="col-sm-12">{input}{error}</div>' ] )->textInput ( [ 'maxlength' => true,'placeholder' => 'Title' ] )->label ( false )?>
