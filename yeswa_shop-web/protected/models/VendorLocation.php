...
/**
* This is the model class for table "tbl_vendor_location".
*
    * @property integer $id
...
class VendorLocation extends \app\components\TActiveRecord
{
...
public static function getVendorOptions()
	{
		...
		//return ArrayHelper::Map ( Vendor::findActive ()->all (), 'id', 'title' );
	...
	*/
	...
	{
		return [
            [['vendor_id', 'location', 'latitude', 'longitude', 'created_on', 'updated_on', 'created_by_id'], 'required'],
            [['vendor_id', 'state_id', 'type_id', 'created_by_id'], 'integer'],
            [['created_on', 'updated_on'], 'safe'],
            [['location', 'latitude', 'longitude'], 'string', 'max' => 256],
            [['created_by_id'], 'exist', 'skipOnError' => true, 'targetClass' => User::className(), 'targetAttribute' => ['created_by_id' => 'id']],
            [['location', 'latitude', 'longitude'], 'trim'],
