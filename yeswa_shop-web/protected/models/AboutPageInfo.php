...
/**
* This is the model class for table "tbl_about_page_info".
*
    * @property integer $id
...
class AboutPageInfo extends \app\components\TActiveRecord
{
...
public static function getPageOptions()
	{
		...
		//return ArrayHelper::Map ( Page::findActive ()->all (), 'id', 'title' );

	}

	 	public function getPage()
	{
		$list = self::getPageOptions();
		return isset($list [$this->page_id])?$list [$this->page_id]:'Not Defined';
	...
	*/
	public function rules()
	{
		return [
            ...
            [['page_id', 'type_id', 'state_id', 'created_by_id'], 'integer'],
