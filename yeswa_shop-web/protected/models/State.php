...
public static function getCountryOptions()
	{
		...
		return ArrayHelper::Map ( Country::findActive ()->all (), 'id', 'country_name' );
	...
	/*  	public function getCountry()
	{
		...
		return isset($list [$this->country_id])?$list [$this->country_id]:'Not Defined';
	...
	*/
	...
	{
		return [
            [['state', 'country_id', 'state_id', 'created_on', 'updated_on', 'created_by_id'], 'required'],
            [['country_id', 'state_id', 'type_id', 'created_by_id'], 'integer'],
