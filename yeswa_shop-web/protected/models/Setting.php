            ...
            if (isset($field['type'])) {
                switch ($field['type']) {
                    case self::KEY_TYPE_BOOL:
                        $html .= "<input type='checkbox' " . $required . " value='" . $value . "' class='form-control' name='Setting[" . $key . "][value]' placeholder='" . Inflector::titleize($key) . "'>";
                        
                        $html .= "<input type='hidden' value='" . self::KEY_TYPE_BOOL . "' name='Setting[" . $key . "][type]'>";
                        $html .= "<input type='hidden' value='" . $typeRequired . "' name='Setting[" . $key . "][required]'>";
