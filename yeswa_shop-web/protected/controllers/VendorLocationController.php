...
use app\models\search\VendorLocation as VendorLocationSearch;
 ...
 */
class VendorLocationController extends TController
{
  public function behaviors() {
    ...
    public function actionMass($action = 'delete')
    {
        ...
        if (! empty($Ids)) {
            foreach ($Ids as $Id) {
                $model = VendorLocation::findOne($Id);
    ...
    public function actionAdd()
    {
        ...
        $model->state_id = VendorLocation::STATE_ACTIVE;
