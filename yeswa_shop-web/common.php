...
if (YII_ENV == 'dev') {
    ...
    defined('PEM_FILE_USER_PATH') or define('PEM_FILE_USER_PATH', dirname(__FILE__) . '/protected/config/acm_yeswaDev.pem');
    
    defined('YII_DEBUG') or define('YII_DEBUG', true);
} else {
    defined('PEM_FILE_USER_PATH') or define('PEM_FILE_USER_PATH', dirname(__FILE__) . '/protected/config/acm_YeswaProd.pem');
